  ...
  return (
    <>
      ...
      <p className="flex items-start gap-2 rounded-xl bg-slate-100 p-3 text-xs font-medium text-slate-600">
        ...
        Nobody can sign up on their own — an account exists only because you added it. Passwords
        are set by each person through their own email and are never shown here.
      </p>
