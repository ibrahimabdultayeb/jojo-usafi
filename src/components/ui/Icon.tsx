...
const paths = {
  ...
  users: ["M9 11a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z", "M2 20c0-3.3 3.1-5.5 7-5.5s7 2.2 7 5.5", "M17 11.5a3 3 0 1 0-1.5-5.6", "M18 20c0-2.2-.8-3.9-2.2-5"],
  dots: ["M5 12h.01", "M12 12h.01", "M19 12h.01"],
  alert: ["M12 3 2 20h20L12 3Z", "M12 10v4", "M12 17h.01"],
  chart: ["M4 20V10", "M10 20V4", "M16 20v-7", "M22 20H2"],
  gear: ["M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z", "M19.4 15a1.6 1.6 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.6 1.6 0 0 0-2.7 1.1V21a2 2 0 1 1-4 0v-.1A1.6 1.6 0 0 0 7.5 19.4l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1A1.6 1.6 0 0 0 3.6 14H3a2 2 0 1 1 0-4h.1A1.6 1.6 0 0 0 4.6 7.5l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1A1.6 1.6 0 0 0 10 3.6V3a2 2 0 1 1 4 0v.1a1.6 1.6 0 0 0 2.7 1.1l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.6 1.6 0 0 0 1.1 2.7H21a2 2 0 1 1 0 4h-.1a1.6 1.6 0 0 0-1.5 1.3Z"],
  eye: ["M2 12s3.6-6 10-6 10 6 10 6-3.6 6-10 6-10-6-10-6Z", "M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"],
  eyeOff: ["m3 3 18 18", "M10.6 10.6a3 3 0 0 0 4.2 4.2", "M9.4 5.2A9.9 9.9 0 0 1 12 5c6.4 0 10 6 10 6a17 17 0 0 1-3.2 3.9", "M6.2 6.6A16.6 16.6 0 0 0 2 11s3.6 6 10 6c1.2 0 2.2-.2 3.2-.5"],
  archive: ["M3 6h18v4H3z", "M5 10v9a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-9", "M10 14h4"],
  refresh: ["M20 11a8 8 0 1 0-1.9 6.1", "M20 5v6h-6"],
  ...
  tag: ["M20.6 12.6 12 21.2 2.8 12V3.8h8.2l9.6 8.8Z", "M7.5 7.5h.01"],
  image: ["M3 5h18v14H3z", "m3 16 5-5 4 4 3-3 6 6", "M8.5 9.5h.01"],
  pin: ["M12 21s7-6.3 7-11a7 7 0 1 0-14 0c0 4.7 7 11 7 11Z", "M12 12.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"],
  banknote: ["M2 6h20v12H2z", "M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z", "M6 9h.01", "M18 15h.01"],
  clipboard: ["M9 4h6v3H9z", "M9 5.5H7a1 1 0 0 0-1 1V20a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V6.5a1 1 0 0 0-1-1h-2"],
} as const;
