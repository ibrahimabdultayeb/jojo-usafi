 ...
 * icon font request.
 *
 * There is deliberately no `whatsapp` entry here. A brand mark is a filled
 * shape, and tracing one with this set's 2px unfilled stroke draws its
 * silhouette as a scribble rather than the glyph — which is exactly what made
 * the admin's WhatsApp buttons look broken. The mark lives in
 * `WhatsAppIcon.tsx` instead, as a filled path.
 */
