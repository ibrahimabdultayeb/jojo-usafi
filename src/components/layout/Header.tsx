  ...
  return (
    <>
      <header className="sticky top-0 z-40 w-full border-b border-slate-200/60 bg-white/85 backdrop-blur-xl">
        <div className="shell flex h-14 items-center gap-1 sm:h-16 sm:gap-4 lg:h-20 lg:gap-8">
          <Logo />
          ...
          <form onSubmit={submitSearch} className="relative hidden max-w-md flex-1 md:block" role="search">
            <Icon name="search" className="pointer-events-none absolute top-1/2 left-4 h-4 w-4 -translate-y-1/2 text-slate-400" />
            <input
              value={term}
              ...
              className="w-full rounded-full border border-transparent bg-slate-100/80 py-2.5 pr-5 pl-11 text-sm font-semibold transition-all placeholder:text-slate-400 focus:border-brand-500 focus:bg-white focus:outline-none"
            />
          </form>
