...
/**
 * Shop by category. On phones this is a horizontal rail so five categories stay
 * one thumb-swipe away instead of pushing the best sellers off the screen.
 */
    ...
    <section className="border-y border-slate-100 bg-white py-8 md:py-12">
      <div className="shell">
        <div className="mb-5 flex items-baseline justify-between gap-4">
          ...
          <Link href="/shop" className="shrink-0 text-xs font-bold text-brand-700 hover:text-brand-800 md:text-sm">
            View all
          </Link>
        </div>
      </div>
        ...
        {categories.map((category) => {
          ...
          return (
            ...
            >
              ...
              <span className="mt-auto text-[11px] font-bold text-slate-400">{total} products</span>
            </Link>
          );
        })}
      </div>
