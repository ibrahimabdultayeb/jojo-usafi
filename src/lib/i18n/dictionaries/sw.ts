...
export const sw: Dictionary = {
  ...
  checkout: {
    ...
    emailHelp: "Ikiwa unataka nakala iliyoandikwa. Hatutumi matangazo kamwe.",
    zone: "Eneo la usafirishaji",
    zoneChoose: "Chagua eneo lako",
    zoneNone: "Bado hatujaweka maeneo ya usafirishaji. Tafadhali tuandikie ili kuagiza.",
    notes: "Maelezo ya usafirishaji",
    notesPlaceholder: "Rangi ya geti, ghorofa, muda mzuri wa kupiga simu",
    payment: "Ungependa kulipa vipi?",
    paymentCash: "Lipa fedha taslimu ukipokea",
    paymentCashNote: "Mlipe dereva fedha taslimu agizo lako linapowasili.",
    paymentDigital: "Lipa kwa simu ukipokea",
    paymentDigitalNote: "Lipa kwa fedha za simu agizo lako linapowasili.",
    free: "BURE",
    discount: "Punguzo",
    total: "Jumla",
    placeOrderWithTotal: "Weka agizo — {total}",
    placing: "Tunaweka agizo lako…",
    priceUpdated: "Bei zilizo hapa chini ni za leo, zimechukuliwa dukani sasa hivi.",
    basketProblem: "Hatukuweza kukamilisha agizo hilo",
    fixBasket: "Badilisha kikapu changu",
    tryAgain: "Jaribu tena",
  },
  confirmation: {
    eyebrow: "Agizo limepokelewa",
    title: "Agizo limepokelewa",
    subtitle: "Asante, {name}. Tutakupigia simu kuthibitisha.",
    orderNumberLabel: "Namba ya agizo lako",
    keepSafe: "Hifadhi namba hii — utaihitaji kufuatilia agizo lako.",
    items: "Ulichoagiza",
    subtotal: "Jumla ndogo",
    delivery: "Usafirishaji",
    total: "Jumla",
    deliveringTo: "Tunafikisha",
    paying: "Unalipa kwa",
    trackMyOrder: "Fuatilia agizo langu",
    whatsappUs: "Una swali? Tuandikie WhatsApp",
    whatsappMessage: "Habari Jojo Usafi, nina swali kuhusu agizo {order}.",
    keepShopping: "Endelea kununua",
  },
  orderStatus: {
    new: "Agizo limepokelewa",
    awaiting_confirmation: "Tunasubiri uthibitisho",
    confirmed: "Limethibitishwa",
    preparing: "Linaandaliwa",
    out_for_delivery: "Linasafirishwa",
    completed: "Limefikishwa",
    cancelled: "Limeghairiwa",
    delivery_failed: "Usafirishaji haukufanikiwa",
  },
  ...
  track: {
    ...
    resultTitle: "Agizo {order}",
    placedOn: "Liliwekwa",
    status: "Hali",
    itemsTitle: "Ulichoagiza",
    totalLabel: "Jumla",
    deliveryLabel: "Tunafikisha",
    notFound: "Hatukupata agizo lenye namba hiyo na namba hiyo ya simu.",
    checking: "Tunatafuta agizo lako…",
    another: "Fuatilia agizo lingine",
  },
