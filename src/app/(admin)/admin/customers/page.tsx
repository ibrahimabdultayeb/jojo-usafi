...
import { customers } from "@/mocks/admin/data";
          ...
          >
            ...
            <span className="min-w-0 flex-1">
              ...
              <span className="mt-0.5 block text-xs font-medium text-slate-500">
                {customer.orderCount} {customer.orderCount === 1 ? "order" : "orders"} · last {customer.lastOrder.toLowerCase()}
              </span>
            </span>
            <span className="shrink-0 text-right">
              <span className="block text-sm font-black text-slate-900 tabular-nums">
                {formatTsh(customer.totalSpend)}
              </span>
